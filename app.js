...
const MehestanGameUI = {
    ...
    enterCity() {
        ...
        const locations = [
            { id: "hospital-pahlavi", name: "بیمارستان کوچه پهلوی", category: "hospital", icon: "🟢", x: 28, y: 31 },
            { id: "hospital-golrokh", name: "بیمارستان کوچه گل‌رخ", category: "hospital", icon: "🟢", x: 63, y: 24 },
            { id: "hospital-central", name: "بیمارستان مرکزی مهستان", category: "hospital", icon: "🟢", x: 51, y: 68 },

            { id: "gold-rose", name: "طلافروشی رز", category: "gold", icon: "🔴", x: 72, y: 42 },
            { id: "gold-nasr", name: "طلافروشی نصر", category: "gold", icon: "🔴", x: 35, y: 72 },
            { id: "gold-shahr", name: "طلافروشی شهر", category: "gold", icon: "🔴", x: 81, y: 70 },

            { id: "mobile-pahlavi", name: "مرکز موبایل پهلوی", category: "mobile", icon: "🟡", x: 44, y: 36 },
            { id: "mobile-kourosh", name: "فروشگاه موبایل کوروش", category: "mobile", icon: "🟡", x: 67, y: 61 },

            { id: "police-central", name: "کلانتری مرکزی مهستان", category: "police", icon: "🔵", x: 24, y: 55 },
            { id: "police-vali", name: "کلانتری ولیعصر", category: "police", icon: "🔵", x: 76, y: 27 },

            { id: "hotel-mahestan", name: "هتل بزرگ مهستان", category: "hotel", icon: "🟣", x: 54, y: 17 },
            { id: "hotel-pars", name: "هتل پارس", category: "hotel", icon: "🟣", x: 86, y: 51 },

            { id: "restaurant-shahr", name: "رستوران شهر", category: "restaurant", icon: "🟠", x: 39, y: 48 },
            { id: "restaurant-night", name: "رستوران شبانه", category: "restaurant", icon: "🟠", x: 61, y: 78 },

            { id: "bank-markazi", name: "بانک مرکزی مهستان", category: "bank", icon: "🟤", x: 18, y: 22 },
            { id: "bank-kourosh", name: "بانک کوروش", category: "bank", icon: "🟤", x: 68, y: 83 },

            { id: "pharmacy-pahlavi", name: "داروخانه پهلوی", category: "pharmacy", icon: "⚪", x: 31, y: 60 },
            { id: "pharmacy-vali", name: "داروخانه ولیعصر", category: "pharmacy", icon: "⚪", x: 89, y: 31 },

            { id: "store-central", name: "فروشگاه مرکزی", category: "store", icon: "🔷", x: 47, y: 57 },
            { id: "telecom-iran", name: "مرکز مخابرات مهستان", category: "telecom", icon: "🩷", x: 14, y: 77 },

            { id: "station", name: "ایستگاه قطار مهستان", category: "station", icon: "🚉", x: 82, y: 87 },
            { id: "gas", name: "پمپ بنزین کوروش", category: "gas", icon: "⛽", x: 10, y: 43 },
            { id: "factory", name: "کارخانه متروکه", category: "factory", icon: "🏭", x: 91, y: 78 },
            { id: "park", name: "پارک قدیمی", category: "park", icon: "🌳", x: 57, y: 51 },
            { id: "newspaper", name: "روزنامه مهستان", category: "newspaper", icon: "📰", x: 27, y: 86 },
            { id: "cityhall", name: "شهرداری مهستان", category: "cityhall", icon: "🏛️", x: 50, y: 88 }
        ];
